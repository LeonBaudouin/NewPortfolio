<template>
  <component :is="tag" class="wrapper">
    <span class="shim"><slot></slot></span><span class="animated" :class="{ show: show }"><slot></slot></span>
  </component>
</template>
...
const delayWithUnits = computed(() => delay + 's')
</script>
...
.animated {
  ...
  animation-delay: v-bind(delayWithUnits);
